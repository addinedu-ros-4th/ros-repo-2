...
class ControlWidget(QWidget, from_class):
    ...
    def __init__(self):
        ...
        self.PATH_LIST = {
            'w1' : [0.3, -1.1], 'w2' : [0.8, -0.75], 'w3' : [1.2, -1.1], 'w4' : [1.5, -1.1],
            'w5' : [0.3, -0.75], 'w6' : [0.8, -0.75], 'w7' : [1.2, -0.75], 'w8' : [1.5, -0.75],
            'w9' : [0.3, -0.4], 'w10' : [0.8, -0.4], 'w11' : [1.2, -0.4], 'w12' : [1.5, -0.4],
            'w13' : [0.3, 0.0], 'w14' : [0.8, 0.0], 'w15' : [1.2, 0.0], 'w16' : [1.5, 0.0],
            'w17' : [0.3, 0.4], 'w18' : [0.8, 0.4], 'w19' : [1.2, 0.4], 'w20' : [1.5, 0.4],
            'w21' : [0.3, 0.75], 'w22' : [0.8, 0.75], 'w23' : [1.2, 0.75], 'w24' : [1.5, 0.75],
            'w25' : [0.3, 1.0], 'w26' : [0.8, 1.0], 'w27' : [1.2, 1.0], 'w28' : [1.5, 1.0],
        }
        
        self.POSITION_DICT = {
            "I1" : [0.5, -1.425],  "I2" : [0.5, -1.1],  "I3" : [0.5, -0.625],
            "O1" : [1.45, 1.06],   "O2" : [1.45, 0.66],   "O3" : [1.45, 0.46],
            "P3" : [0.4, 1.2],    "P2" : [0.4, 0.6],    "P1" : [0.4, 0.1],
            "R1" : [1.45, -1.2],   "R2" : [1.45, -0.9],
            "A1" : [0.7, 0.3],    "A1_2" : [0.7, 0.3], 
            "A2" : [1.37, 0.3],    "A2_2" : [1.37, 0.3],
            "B1" : [0.7, -0.5],   "B1_2" : [0.7, -0.5], 
            "B2" : [1.37, -0.5],   "B2_2" : [1.37, -0.5],
            "C1" : [0.7, -1.2],   "C1_2" : [0.7, -1.2], 
